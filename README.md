...
The analytical (handbook) solution
Finite element analysis in ANSYS
Near-tip displacement field extraction, post-processed in MATLAB
...
For a centre-cracked plate of finite width under remote tension:
Code
where σ is the applied nominal stress, a is the half-crack length, and Y is the finite-width geometry correction factor. For a centre crack in a finite strip:
Code
The near-tip displacement field is:
Code
with
...
Nodal displacements in the vicinity of the crack tip are exported from the FE solution and fitted to the LEFM asymptotic form in MATLAB. The crack-opening displacement δ = 2u_y along the crack face (θ = π) gives:
Code
